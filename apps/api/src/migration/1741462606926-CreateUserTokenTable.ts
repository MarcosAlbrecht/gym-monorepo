...
export class CreateUserTokenTable1741462606926 implements MigrationInterface {
    name = 'CreateUserTokenTable1741462606926'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_usuario_token" ("id" varchar PRIMARY KEY NOT NULL, "refresh_token" varchar(255) NOT NULL, "expiracao_token" datetime NOT NULL, "dt_inclusao" datetime NOT NULL DEFAULT (CURRENT_TIMESTAMP), "id_usuario" varchar, CONSTRAINT "REL_98f38347099798d02785592a67" UNIQUE ("id_usuario"), CONSTRAINT "FK_98f38347099798d02785592a671" FOREIGN KEY ("id_usuario") REFERENCES "usuario" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
