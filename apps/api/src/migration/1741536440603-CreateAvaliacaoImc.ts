...
export class CreateAvaliacaoImc1741536440603 implements MigrationInterface {
    name = 'CreateAvaliacaoImc1741536440603'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "avaliacao_imc" ("id" varchar PRIMARY KEY NOT NULL, "altura" decimal(5,2) NOT NULL, "peso" decimal(5,2) NOT NULL, "imc" decimal(5,2) NOT NULL, "dt_inclusao" datetime NOT NULL DEFAULT (CURRENT_TIMESTAMP), "id_usuario_avaliacao" varchar, "id_usuario_aluno" varchar)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_avaliacao_imc" ("id" varchar PRIMARY KEY NOT NULL, "altura" decimal(5,2) NOT NULL, "peso" decimal(5,2) NOT NULL, "imc" decimal(5,2) NOT NULL, "dt_inclusao" datetime NOT NULL DEFAULT (CURRENT_TIMESTAMP), "id_usuario_avaliacao" varchar, "id_usuario_aluno" varchar, CONSTRAINT "FK_d276f2482c6d64ddc36c3229fa6" FOREIGN KEY ("id_usuario_avaliacao") REFERENCES "usuario" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_b3b4bd4196d4d625dc4307412e8" FOREIGN KEY ("id_usuario_aluno") REFERENCES "usuario" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_avaliacao_imc"("id", "altura", "peso", "imc", "dt_inclusao", "id_usuario_avaliacao", "id_usuario_aluno") SELECT "id", "altura", "peso", "imc", "dt_inclusao", "id_usuario_avaliacao", "id_usuario_aluno" FROM "avaliacao_imc"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "avaliacao_imc" ("id" varchar PRIMARY KEY NOT NULL, "altura" decimal(5,2) NOT NULL, "peso" decimal(5,2) NOT NULL, "imc" decimal(5,2) NOT NULL, "dt_inclusao" datetime NOT NULL DEFAULT (CURRENT_TIMESTAMP), "id_usuario_avaliacao" varchar, "id_usuario_aluno" varchar)`);
        await queryRunner.query(`INSERT INTO "avaliacao_imc"("id", "altura", "peso", "imc", "dt_inclusao", "id_usuario_avaliacao", "id_usuario_aluno") SELECT "id", "altura", "peso", "imc", "dt_inclusao", "id_usuario_avaliacao", "id_usuario_aluno" FROM "temporary_avaliacao_imc"`);
